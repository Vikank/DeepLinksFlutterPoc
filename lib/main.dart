import 'dart:async';
import 'package:deep_links_flutter_poc/path_constant.dart';
import 'package:deep_links_flutter_poc/route_services.dart';
  ...
  Future<void> _createDynamicLink(bool short, String link) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      androidParameters: const AndroidParameters(
        packageName: 'com.example.deep_links_flutter_poc',
        minimumVersion: 0,
      ),
    );
